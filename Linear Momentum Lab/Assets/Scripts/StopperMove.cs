...
public class StopperMove : MonoBehaviour
{
    ...
    private double timerEnd = 2.2;
    private double ReflectReappear = 0.25;
    private bool ReflectActive = false;
    public bool ReflectExists;
    ...
    void Update()
    {
        ...
        ReflectExists = (GameObject.FindWithTag("Reflect") != null);

        if (ReflectActive == true)
        {
            if (ReflectExists == false)
            {
                if (block == 90)
                {
