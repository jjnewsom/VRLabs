...
{
    public GameObject ninetyDeflection;
    ...
    void Update()
    {
        ...
        if(checker == true)
        {
            this.gameObject.transform.Rotate(Vector3.up* 1 * Time.deltaTime);
        }
    }
    ...
    {
        if (block.gameObject.name == "90 Target")
        {
            Instantiate(ninetyDeflection);
        }
        else if (block.gameObject.name == "135 Target")
        {
            Instantiate(oneThirtyFiveDeflection);
        }
        else if (block.gameObject.name == "180 Target")
        {
